...
class Block(object):
    ...
    Attributes:
        ...
        flat_type (str): The type of flat the block is. Human-readable form.
    ...
    def __init__(self, town: str, flat_type: str, block_code: BlockCode,
    ...
    @staticmethod
    def scrape(town: str, flat_type: str, block_code: BlockCode,
               block_details: Tuple[str, str, str, str, str],
               apt_details: List[Tuple[str, str]]) -> 'Block':
        """
        ...
        Args:
            ...
            apt_details (list): List of tuple of strings containing the raw apartment number
                                    and lease pricing
